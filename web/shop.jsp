	...
	<div class="row blog_1">
	   <div class="col-md-9">
	     ...
	     <div class="col-md-8">
	       ...
	       <!-- TODO: Phần danh sách sản phẩm sẽ tự sinh ra từ Servlet -->
    ...
    <div class="col mb-4">
      <div class="shop_left">
        <div class="shop_left1 position-relative">
          <div class="shop_left1_inner">
            <a href="detail.jsp?id=${x.id}">
              <img src="${x.hinhAnh}" alt="${x.tenXe}" class="img-fluid">
            </a>
          </div>

          <div class="shop_left1_inner1 position-absolute top-0 p-3">
            <b class="d-inline-block bg_red text-white p-1 px-3 font_14">${x.trangThai}</b>
          </div>

          <div class="shop_left1_inner2 position-absolute w-100 h-100 bg_back top-0 text-center">
            <h5>
              <a class="button px-3" href="cart.jsp?add=${x.id}">
                Add to cart <i class="fa fa-long-arrow-right ms-2"></i>
              </a>
            </h5>
          </div>
        </div>
        ...
        <div class="shop_left2 mt-3">
          ...
          <ul class="mb-0 fs-5">
            <li>
              <a class="justify-content-between d-flex" href="detail.jsp?id=${x.id}">
                ${x.tenXe}
                <span>
                  <span class="text-decoration-line-through fw-normal text-muted me-2">
                    <fmt:formatNumber value="${x.giaGoc}" type="number" groupingUsed="true"/> ₫
                  </span>
