	...
	<div class="cart_3 row mt-3">
	 <div class="col-md-8">
	  ...
	  <div class="cart_3l1 mt-3 row ms-0 me-0">
	   <div class="col-md-3 ps-0 col-3">
	    <div class="cart_3l1i">
		 <a href="#"><img src="image/32.jpg" alt="abc" class="img-fluid"></a>		</div>
	   </div>
	   <div class="col-md-9 col-9">
	    <div class="cart_3l1i1">
		 <h6 class="fw-bold"><a href="#">Sản Phẩm 2 </a></h6>
		 <h6 class="fw-normal font_14 mt-3">RED / XS</h6>
		 <h6 class="font_14 mt-3">Vendor</h6>
		 <h5 class="col_red mt-3">$175.00</h5>
		 <h6 class="font_14 mt-3 mb-3">Số Lượng</h6>
	  ...
	  <div class="cart_3l1 mt-3 row ms-0 me-0 pb-0 border-0">
	   <div class="col-md-3 ps-0 col-3">
	    <div class="cart_3l1i">
		 <a href="#"><img src="image/35.jpg" alt="abc" class="img-fluid"></a>		</div>
	   </div>
	   <div class="col-md-9 col-9">
	    <div class="cart_3l1i1">
		 <h6 class="fw-bold"><a href="#">Sản phẩm 3</a></h6>
		 <h6 class="fw-normal font_14 mt-3">RED / XS</h6>
		 <h6 class="font_14 mt-3">Vendor</h6>
		 <h5 class="col_red mt-3">$175.00</h5>
		 <h6 class="font_14 mt-3 mb-3">Số Lượng</h6>
	 ...
	 <div class="col-md-4">
	  <div class="cart_3r">
	   ...
	   <h3 class="text-center col_red mt-3">$1,347.00</h3>
	   <hr>
	   <h6 class="font_14">Additional comments</h6>
	   <textarea class="form-control"></textarea>
	   <h6 class="text-center mt-3"><a class="button" href="checkout.jsp">Tiến Hành Thanh Toán</a></h6><br>
	   </div>
	 </div>
	</div>
 </div>	 
